      ...
      <div class="container-fluid">
        ...
        <div class="main-box">
          ...
          <div class="outer-box">
            <div class="btn-box">
              {
                current ?  <a href='/dashboard'  class="theme-btn btn-style-six call-modal">DashBoard</a> :  <a href='#' onClick = {handleShow} class="theme-btn btn-style-six call-modal">Login / Register</a>
              }
