              ...
              <div class="row">
                ...
                <div class="candidate-block-four col-lg-4 col-md-6 col-sm-12">
                  <div class="inner-box">
                    ...
                    <span class="thumb"><img style = {{height : '100%', objectFit : 'cover', }} src="images/resource/2.png" alt=""/></span>
                    <h3 class="name"><a href="#">Isaac Dinidomo</a></h3>
                    ...
                    <a href="/profile" class="theme-btn btn-style-three">View Profile</a>
                  </div>
                </div>
                ...
                <div class="candidate-block-four col-lg-4 col-md-6 col-sm-12">
                  <div class="inner-box">
                    ...
                    <span class="thumb"><img style = {{height : '100%', objectFit : 'cover', }} src="images/resource/1.png" alt=""/></span>
                    <h3 class="name"><a href="#">Success Uchenna</a></h3>
                ...
                <div class="candidate-block-four col-lg-4 col-md-6 col-sm-12">
                  <div class="inner-box">
                    ...
                    <span class="thumb"><img style = {{height : '100%', objectFit : 'cover', }} src="images/resource/3.png" alt=""/></span>
                    <h3 class="name"><a href="#">Leslie Alexander</a></h3>
                    <span class="cat">Developer</span>
                    <ul class="job-info">
                      <li><span class="icon flaticon-map-locator"></span> London, UK</li>
                      <li><span class="icon flaticon-money"></span> $99 / hour</li>
                ...
                <div class="candidate-block-four col-lg-4 col-md-6 col-sm-12">
                  <div class="inner-box">
                    ...
                    <span class="thumb"><img style = {{height : '100%', objectFit : 'cover', }} src="images/resource/4.png"/></span>
                ...
                <div class="candidate-block-four col-lg-4 col-md-6 col-sm-12">
                  <div class="inner-box">
                    ...
                    <span class="thumb"><img style = {{height : '100%', objectFit : 'cover', }} src="images/resource/5.jpg" alt=""/></span>
                    <h3 class="name"><a href="#">Sandra George</a></h3>
                    <span class="cat">Developer</span>
                    <ul class="job-info">
                      <li><span class="icon flaticon-map-locator"></span> London, UK</li>
                      <li><span class="icon flaticon-money"></span> $99 / hour</li>
