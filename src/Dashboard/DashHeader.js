...
console.log('main', current)
    ...
    <header class="main-header header-shaddow">
      <div class="container-fluid">
        ...
        <div class="main-box">
          ...
          <div class="nav-outer">
            <div class="logo-box">
              <div class="logo"><a href="index.html"><img src="images/qlinklogo.png"  style = {{width : '100px'}} alt="" title=""/></a></div>
            </div>
          ...
          <div class="outer-box">
            ...
            <div class="dropdown dashboard-option">
              <a class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="false">
                <img style = {{objectFit : 'cover', width : '40px', height : '40px'}}  src={current?.avatar} alt="avatar" class="thumb"/>
      ...
      <div class="mobile-header">
        <div class="logo"><a href="index.html"><img src="images/qlinklogo.png"  style = {{width : '100px', objectFit :'contain'}} alt="" title=""/></a></div>
        ...
        <div class="nav-outer clearfix">
          ...
          <div class="outer-box">
            ...
            <button id="toggle-user-sidebar"><img style = {{objectFit : 'cover', width : '40px', height : '40px'}}  src={current?.avatar} alt="avatar" class = "thumb" /></button>
 ...
 <div class="user-sidebar">
      ...
      <div class="sidebar-inner">
        <ul class="navigation">
          <li class=""><a href="/dashboard"> <i class="la la-home"></i> Dashboard</a></li>
          <li><a href="/mainprofile"><i class="la la-user-tie"></i>My Profile</a></li>
          {/* <li><a href="candidate-dashboard-resume.html"><i class="la la-file-invoice"></i>My Resume</a></li> */}
          <li><a href="/jobapplied"><i class="la la-briefcase"></i> Applied Jobs </a></li>
               {
                 current?.isDeveloper ? null :    <li class=""><a href="/postjobs"><i class="la la-paper-plane"></i>Post a New Job</a></li>
               }
                    <li class=""><a href="/managejobs"><i class="la la-briefcase"></i> Manage Jobs </a></li>

          {/* <li><a href="candidate-dashboard-job-alerts.html"><i class="la la-bell"></i>Job Alerts</a></li> */}
          <li><a href="/shortlistjobs"><i class="la la-bookmark-o"></i>Job Alert</a></li>
          {/* <li><a href="candidate-dashboard-cv-manager.html"><i class="la la-file-invoice"></i> CV manager</a></li> */}
          {/* <li><a href="dashboard-packages.html"><i class="la la-box"></i>Packages</a></li> */}
          {/* <li><a href="dashboard-messages.html"><i class="la la-comment-o"></i>Messages</a></li> */}
          {/* <li><a href="dashboard-change-password.html"><i class="la la-lock"></i>Change Password</a></li> */}
